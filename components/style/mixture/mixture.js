...
export const mixtureStyle = {
  ...
  header: `${position.header} ${size.height.header} ${size.width.header} ${color.background.header} ${outline.header} ${color.outline.base_note} ${hover.size.header} ${transition.header}`,
};
