export const size = {
  width: {
    ...
    postListBox: "w-[100%] mt-[%] px-[20px]",
    postList: "w-[100%] max-w-[800px] mt-[7%] mb-[40px] [&_li]:w-[calc(90%/3)] [&_li]:rounded-[10px] [&_li]:mx-[10px] [&_li]:my-[10px] [&_li]:p-[10px]",
  ...
  height: {
    ...
    page: "h-[72%]",
    button: "",
    searchBox: "h-[50%] [&_input]:h-[50%]",
    tag: "",
    titleBox: "h-[60px]",
    postListBox: "h-[100%]",
    postList: "[&_li]:h-[100px]",
